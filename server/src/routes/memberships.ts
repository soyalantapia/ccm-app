 ...
 * y como POST /devices emite tokens sin pedir credenciales, cualquiera podía hacerse socio gratis
 * salteándose el checkout entero. La activación real pasa por el webhook, que es el único que
 * puede afirmar que la plata entró (mpWebhookService.activar → becomeSocio).
 *
 * Sin MP conectado se deja pasar, que es el modo demo del proyecto: sin pasarela no hay forma de
 * cobrar y bloquearlo dejaría la función muerta. Mismo criterio condicional que assertProd usa
 * para los secretos de MP.
 */
