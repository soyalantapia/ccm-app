...
Pendiente del roadmap (Bloque 3): variedad de seed (galerías/sponsor/capacitación/CRM 15-25 personas), `.ics`, chips de logo de sponsors, ritmo vertical/cadencia de bloques oscuros, wordmark/monograma con corazón, caché de hero.mp4 + prefers-reduced-motion, limpiar tracking (page_view/qr_view fuera del feed), QR de stand → lead-gen demo, prerender de rutas públicas (SEO + LCP<2,5s en frío).
